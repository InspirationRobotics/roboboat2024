...
from auv.missions import gate_mission, cointoss_mission, surfacing_mission, dhd_approach_mission
from auv.utils import arm, disarm, deviceHelper
from auv.motion import robot_control
import rclpy

myNode = rclpy.init_node("missions", anonymous=True)
#octagon_heading = 350
time.sleep(30)
...
def onExit(signum, frame):
    try:
        ...
        myNode.stop()
        time.sleep(3)
        rclpy.signal_shutdown("Rospy Exited")
